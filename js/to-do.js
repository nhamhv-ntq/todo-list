...
var clearTaskComplete  = function(event) {
    event.preventDefault();
...
document.getElementById('toggle-input').addEventListener('click', toggleTask, false);

document.getElementById('clear-complete').addEventListener('click', clearTaskComplete, false);
